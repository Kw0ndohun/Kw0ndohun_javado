...
<%--학습 진행도 게이지--%>
<div class="progress">
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100" style="width: 31%;"></div>
</div>
<%--자바(캐릭터)가 있는 곳--%>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    1이의 키가 너무 커져서 위에 있는 친구의 키를 빼려고 해요. 빼는 블록을 넣어보세요.
  </div>
</div>
...
<div class="container" id="answerCon">
  <div class="column" id="inButton">
    <div class="list-group-item" draggable="true"><h1>무엇이 들어갈까요</h1>
      <div class="answerDiv" id="step7answerDiv"></div>
    </div>
...
<div class="alert alert-dismissible alert-primary">
  ...
  <strong>좋아요!</strong> 이제 Step 7예요. 이번 문제도 잘 풀어보아요.
</div>

...
<%--학습 진행도 게이지--%>
<div class="progress">
  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100" style="width: 16%;"></div>
</div>
<%--자바(캐릭터)가 있는 곳--%>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    1이는 20억정도의 크기를 가질 수 있는 int보다 더 커질 수 있는 모임에 가입하게 되었어요. 20억보다 커질 수 있는 숫자들의 모임 블록을 넣어보세요.
  </div>
</div>
...
<div class="alert alert-dismissible alert-primary">
  ...
  <strong>좋아요!</strong> 이제 Step 4예요. 이번 문제도 잘 풀어보아요. <a href="#" class="alert-link">this important alert message</a>.
</div>

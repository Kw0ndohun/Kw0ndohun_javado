...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    1이 혼자 아무 곳에도 속하지 못 했어요. 1이가 숫자들의 모임에 속할 수 있게, 숫자들의 모임을 넣어주세요.
  </div>
</div>
...
<div class="buttonContainer">
  <div class="buttons">
    ...
    <button type="button" class="btn btn-outline-success" draggable="true" value="split" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="auto" data-bs-content="성형하기" data-bs-trigger="hover">split</button>
    <button type="button" class="btn btn-outline-danger" draggable="true" value="subString" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="auto" data-bs-content="친구의 일부분만 확인하기" data-bs-trigger="hover">subString</button>
...
<div class="container" id="answerCon">
  <div class="column" id="inButton">
    <div class="list-group-item" draggable="true"><h1>무엇이 들어갈까요</h1>
      <div class="answerDiv" id="step1answerDiv"></div>
    </div>
...
<div class="alert alert-dismissible alert-primary">
  ...
  <strong>어서오세요!</strong> 좋아요! Step 1부터 해볼까요. <a href="#" class="alert-link">this important alert message</a>.
</div>

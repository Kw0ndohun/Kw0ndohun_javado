  ...
  <div class="column" id="inButton">
    <div class="list-group-item" draggable="true"><h1>무엇이 들어갈까요</h1>
      <div class="container" id="inButtonBox">
        <div class="questionDiv2" id="m41Question2">for(int i=0; i<20; i </div>
        <div class="answerDiv" id="step<%=step%>answerDiv"></div>
        <div class="questionDiv4" id="m41Question4">){} </div>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
      이번엔 세번째 식을 볼게요. i++ 라고 되어 있었는데 반복될 때마다 i에게 +1을 해주는거예요. 한 번 블록을 넣어보세요.
  </div>
</div>
<%--실행화면--%>

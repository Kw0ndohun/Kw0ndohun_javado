  ...
  <div class="column" id="inButton">
    <div class="list-group-item" draggable="true"><h1>무엇이 들어갈까요</h1>
      <div class="container" id="inButtonBox">
        <div class="questionDiv2" id="m39Question2">for(int i=0; i </div>
        <div class="answerDiv" id="step<%=step%>answerDiv"></div>
        <div class="questionDiv4" id="m36Question4">20; i++){} </div>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
      for은 조금 특이한 식을 조건을 가져요. 가운데 있는 식이 진실이여야 실행이 되요. i=0이네요. 블록을 넣어보세요.
  </div>
</div>
<%--실행화면--%>
